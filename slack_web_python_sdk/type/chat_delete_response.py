...
class RequiredChatDeleteResponse(TypedDict):
    channel: DefsChannel
...
class OptionalChatDeleteResponse(TypedDict, total=False):
    pass

class ChatDeleteResponse(RequiredChatDeleteResponse, OptionalChatDeleteResponse):
    pass
