...
class RequiredFilesListResponse(TypedDict):
...
class OptionalFilesListResponse(TypedDict, total=False):
    pass

class FilesListResponse(RequiredFilesListResponse, OptionalFilesListResponse):
    pass
