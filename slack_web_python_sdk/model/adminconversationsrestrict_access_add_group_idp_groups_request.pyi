...
class AdminconversationsrestrictAccessAddGroupIdpGroupsRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel_id", "group_id", "token", "team_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel_id", "group_id", "token", "team_id", ], str]):
