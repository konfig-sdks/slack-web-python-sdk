...
class UsergroupsDisableRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["usergroup", "include_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["usergroup", "include_count", ], str]):
