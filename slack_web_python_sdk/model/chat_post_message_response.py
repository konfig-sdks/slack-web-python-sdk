...
class ChatPostMessageResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel", "message", "ok", "ts", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel", "message", "ok", "ts", ], str]):
