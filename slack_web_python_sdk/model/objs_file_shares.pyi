...
class ObjsFileShares(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["private", "public", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["private", "public", ], str]):
