...
class UsersSetPhotodefaultResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["error", "ok", "callstack", "debug_step", "dims", "time_ident", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["error", "ok", "callstack", "debug_step", "dims", "time_ident", ], str]):
