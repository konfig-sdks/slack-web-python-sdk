...
class UsergroupsUpdateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["usergroup", "description", "channels", "handle", "include_count", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["usergroup", "description", "channels", "handle", "include_count", "name", ], str]):
