...
class ChatGetPermalinkResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["channel", "ok", "permalink", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["channel", "ok", "permalink", ], str]):
