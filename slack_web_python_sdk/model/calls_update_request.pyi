...
class CallsUpdateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "title", "desktop_app_join_url", "join_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "title", "desktop_app_join_url", "join_url", ], str]):
