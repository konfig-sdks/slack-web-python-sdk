...
class TeamInfoResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ok", "team", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ok", "team", ], str]):
