...
class ChatMeMessageResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ok", "channel", "ts", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ok", "channel", "ts", ], str]):
