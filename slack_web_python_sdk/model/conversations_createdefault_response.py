...
class ConversationsCreatedefaultResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["error", "ok", "callstack", "detail", "needed", "provided", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["error", "ok", "callstack", "detail", "needed", "provided", ], str]):
