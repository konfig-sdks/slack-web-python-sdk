...
class ConversationsOpenResponse(BaseModel):
    channel: typing.List[typing.Union[typing.List[ObjsConversation], typing.List[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]]] = Field(alias='channel')

    ok: DefsOkTrue = Field(alias='ok')

    already_open: typing.Optional[bool] = Field(None, alias='already_open')

    no_op: typing.Optional[bool] = Field(None, alias='no_op')
    class Config:
