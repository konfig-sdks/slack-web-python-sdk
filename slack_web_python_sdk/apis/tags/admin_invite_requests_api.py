...
from slack_web_python_sdk.apis.tags.admin_invite_requests_api_raw import AdminInviteRequestsApiRaw
...
class AdminInviteRequestsApi(
    ...
    """
    raw: AdminInviteRequestsApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = AdminInviteRequestsApiRaw(api_client)
